module github.com/ramon-reichert/locallens

go 1.25.3

require github.com/ardanlabs/kronk v1.17.4
...
require (
	...
	github.com/hybridgroup/yzma v1.6.1-0.20260205112702-c1db16fb3fc0 // indirect
